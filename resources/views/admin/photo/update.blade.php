        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">@if($type==0)摄影海报信息修改@elseif($type==1)摄影信息修改@elseif($type==2)摄影师信息修改@endif</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input  class="form-control" name="photo[title]"
                                            value="{{ old('photo')['title'] ? old('photo')['title'] : $photo->title }}"
                                            required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input  class="form-control" name="photo[content]"
                                            value="{{ old('photo')['content'] ? old('photo')['content'] : $photo->content }}"
                                            required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input  class="form-control" name="photo[author]"
                                            value="{{ old('photo')['author'] ? old('photo')['author'] : $photo->author }}"
                                            required autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input  class="form-control" name="photo[tag]"
                                            value="{{ old('photo')['tag'] ? old('photo')['tag'] : $photo->tag }}"
                                            >
                                </div>
                            </div>
